      ...
      fetch(`https://robohash.org/${escapedTextInput}/?set=set1&size=200x200`)
        ...
        <section id="main-robot">
            <div className="row ">
                ...
                <img src={robot ?? defaultRobot} className="img-fluid" alt="robot icon" />
            ...
            <input className="border border-dark my-2" type="text" placeholder="Enter text"value={textInput} onChange={(e) => setTextInput(e.target.value)}></input>
            </label>
